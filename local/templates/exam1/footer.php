	...
	array(
		...
		"COMPONENT_TEMPLATE" => "exam_slider_rewiev"
	),
	false
);?>
</div>
        ...
        <div class="inner-wrap">
            <nav class="main-menu">
                <div class="item">
                    ...
                    <?$APPLICATION->IncludeComponent("bitrix:menu", "exam_bottom_menu", Array(
            ...
            <div class="contacts-block">
                <div class="title-block"><?=GetMessage("FTR_CONTAKT_INFO_TITLE");?></div>
                <div class="loc-block">
