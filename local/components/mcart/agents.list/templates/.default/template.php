...
// print_r($arParams); // для разработки в конечном коде убрать
// echo '</pre>';
    ...
    <div class="mb-5">
        ...
        <div class="agent__card">
            <div class="small-info">
                <div class="avatar" style="background-image: url(<?= $arItem["UF_PHOTO_VALUE"]?? '/images/no-avatar.png' ?>);"></div>
                <div class="info">
            ...
            <div class="agent__card_item">
                <div class="agent__card_info">
                    <div class="card__info_item">
                        <div class="position"><?=GetMessage("AGENTS_MAIL")?>: </div>
                    ...
                    <div class="card__info_item">
                        ...
                        <div class="name"><?=$arItem["UF_TYPE_VALUE"]?></div>
                    </div>
                </div>
            </div>
